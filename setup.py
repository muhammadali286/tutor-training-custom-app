#!/usr/bin/env python
"""
Package metadata for training_custom_django_app.
"""
import os
import re
import sys
...
VERSION = get_version('training_custom_django_app', '__init__.py')
...
setup(
    name='training-custom-django-app',
    version=VERSION,
    description="""One-line description for README and other doc files.""",
    long_description=README + '\n\n' + CHANGELOG,
    author='Ali',
    author_email='muhammad.ali@arbisoft.com',
    url='https://github.com/arbisoft/training-custom-django-app',
    packages=find_packages(
        include=['training_custom_django_app', 'training_custom_django_app.*'],
        exclude=["*tests"],
    ),
    ...
    entry_points={
        "lms.djangoapp": [
            "training_custom_django_app = training_custom_django_app.apps:TrainingCustomDjangoAppConfig",
        ],
        "cms.djangoapp": [
            "training_custom_django_app = training_custom_django_app.apps:TrainingCustomDjangoAppConfig",
        ],
