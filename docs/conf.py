...
"""
training-custom-django-app documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'training-custom-django-app',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/arbisoft/training-custom-django-app",
...
#
# html_title = 'training-custom-django-app v0.1.0'
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'training_custom_django_app'),
                os.path.join(root_path, 'training_custom_django_app/migrations')])
